...
class MyScript(Script):
    def get_scheme(self):
        ...
        scheme.description = (
            ...
            "to perfom web spider scan and post results back via HEC."
    ...
    def stream_events(self, inputs, ew):
        ...
        try:
            logger.info("Trying to POST to " + worker_url + "/discovery/web_spider/")
            response = session.post(
                worker_url + "/discovery/web_spider/",
                headers=headers,
                json=json_data,
            )
